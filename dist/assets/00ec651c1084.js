import{dT as e,cN as t,cS as i,dY as n,gl as r,dU as o,dX as s,cV as a,cM as c,cO as l,cT as u,e2 as d,eT as h,dZ as p,cL as m,d_ as f,d$ as w,ex as g}from"./00ec651c.js";import{n as k,r as v}from"./00ec651c1007.js";import{c as x,a as b,U as y,r as $,e as A}from"./00ec651c1008.js";import{e as T,n as C}from"./00ec651c1014.js";import"./00ec651c1010.js";import"./00ec651c1019.js";import"./00ec651c1011.js";import"./00ec651c1018.js";import{S as P}from"./00ec651c1017.js";import"./00ec651c1013.js";import"./00ec651c1053.js";import"./00ec651c1012.js";import"./00ec651c1020.js";import{o as R}from"./00ec651c845.js";import"./00ec651c2.js";import"./00ec651c3.js";import"./00ec651c1009.js";import"./00ec651c1016.js";const N=x`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let O=class extends e{constructor(){super(...arguments),this.readOnly=!1}render(){const e=this.readOnly||!this.token;return o` <wui-flex
    ...
    </wui-flex>`}onInputChange(e){r.setTokenAmount(e.detail)}onMaxClick(){if(this.token){const e=a.bigNumber(this.token.quantity.numeric);r.setTokenAmount(Number(e.toFixed(20)))}}onBuyClick(){s.push("OnRampProviders")}};O.styles=I,B([k({type:Object})],O.prototype,"token",void 0),B([k({type:Boolean})],O.prototype,"readOnly",void 0),B([k({type:Number})],O.prototype,"sendTokenAmount",void 0),O=B([b("w3m-input-token")],O);const E=x`
  :host {
    display: block;
  }
...
`;var D=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let z=class extends e{constructor(){super(),this.unsubscribe=[],this.token=r.state.token,this.sendTokenAmount=r.state.sendTokenAmount,this.receiverAddress=r.state.receiverAddress,this.receiverProfileName=r.state.receiverProfileName,this.loading=r.state.loading,this.params=s.state.data?.send,this.caipAddress=c.state.caipAddress,this.message="Preview Send",this.token&&!this.params&&(this.fetchBalances(),this.fetchNetworkPrice()),this.unsubscribe.push(c.subscribeKey("caipAddress",e=>{this.caipAddress=e}),r.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.loading=e.loading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}async firstUpdated(){await this.handleSendParameters()}render(){this.getMessage();const e=Boolean(this.params);return o` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    </wui-flex>`}async fetchBalances(){await r.fetchTokenBalance(),r.fetchNetworkBalance()}async fetchNetworkPrice(){await P.getNetworkTokenPrice()}onButtonClick(){s.push("WalletSendPreview",{send:this.params})}getMessage(){if(this.message="Preview Send",this.receiverAddress&&!t.isAddress(this.receiverAddress,i.state.activeChain)&&(this.message="Invalid Address"),this.receiverAddress||(this.message="Add Address"),this.sendTokenAmount&&this.token&&this.sendTokenAmount>Number(this.token.quantity.numeric)&&(this.message="Insufficient Funds"),this.sendTokenAmount||(this.message="Add Amount"),this.sendTokenAmount&&this.token?.price){this.sendTokenAmount*this.token.price||(this.message="Incorrect Value")}this.token||(this.message="Select Token")}async handleSendParameters(){if(this.loading=!0,!this.params)return void(this.loading=!1);const e=Number(this.params.amount);if(isNaN(e))return l.showError("Invalid amount"),void(this.loading=!1);const{namespace:t,chainId:n,assetAddress:o}=this.params;if(!u.SEND_PARAMS_SUPPORTED_CHAINS.includes(t))return l.showError(`Chain "${t}" is not supported for send parameters`),void(this.loading=!1);const s=i.getCaipNetworkById(n,t);if(!s)return l.showError(`Network with id "${n}" not found`),void(this.loading=!1);try{const{balance:t,name:i,symbol:n,decimals:a}=await d.fetchERC20Balance({caipAddress:this.caipAddress,assetAddress:o,caipNetwork:s});if(!(i&&n&&a&&t))return void l.showError("Token not found");r.setToken({name:i,symbol:n,chainId:s.id.toString(),address:`${s.chainNamespace}:${s.id}:${o}`,value:0,price:0,quantity:{decimals:a.toString(),numeric:t.toString()},iconUrl:h.getTokenImage(n)??""}),r.setTokenAmount(e),r.setReceiverAddress(this.params.to)}catch(a){l.showError("Failed to load token information")}finally{this.loading=!1}}};z.styles=E,D([v()],z.prototype,"token",void 0),D([v()],z.prototype,"sendTokenAmount",void 0),D([v()],z.prototype,"receiverAddress",void 0),D([v()],z.prototype,"receiverProfileName",void 0),D([v()],z.prototype,"loading",void 0),D([v()],z.prototype,"params",void 0),D([v()],z.prototype,"caipAddress",void 0),D([v()],z.prototype,"message",void 0),z=D([b("w3m-wallet-send-view")],z);const U=x`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`;var H=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let V=class extends e{constructor(){super(),this.unsubscribe=[],this.tokenBalances=r.state.tokenBalances,this.search="",this.onDebouncedSearch=t.debounce(e=>{this.search=e}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(r.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return o`
    ...
    `}async fetchBalancesAndNetworkPrice(){this.tokenBalances&&0!==this.tokenBalances?.length||(await this.fetchBalances(),await this.fetchNetworkPrice())}async fetchBalances(){await r.fetchTokenBalance(),r.fetchNetworkBalance()}async fetchNetworkPrice(){await P.getNetworkTokenPrice()}templateSearchInput(){return o`
    ...
    `}onBuyClick(){s.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){r.setToken(e),r.setTokenAmount(void 0),s.goBack()}};V.styles=U,H([v()],V.prototype,"tokenBalances",void 0),H([v()],V.prototype,"tokens",void 0),H([v()],V.prototype,"filteredTokens",void 0),H([v()],V.prototype,"search",void 0),V=H([b("w3m-wallet-send-select-token-view")],V);const L=x`
  :host {
    height: 32px;
    display: flex;
    align-items: center;
...
`;var F=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let q=class extends e{constructor(){super(...arguments),this.text=""}render(){return o`<wui-text variant="lg-regular" color="primary">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.address?o`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?o`<wui-image src=${this.imageSrc}></wui-image>`:o`<wui-icon size="lg" color="inverse" name="networkPlaceholder"></wui-icon>`}};q.styles=[$,A,L],F([k({type:String})],q.prototype,"text",void 0),F([k({type:String})],q.prototype,"address",void 0),F([k({type:String})],q.prototype,"imageSrc",void 0),q=F([b("wui-preview-item")],q);const M=x`
  :host {
    display: flex;
...
`;var _=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let W=class extends e{constructor(){super(...arguments),this.imageSrc=void 0,this.textTitle="",this.textValue=void 0}render(){return o`
      <wui-flex justifyContent="space-between" alignItems="center">
        <wui-text variant="lg-regular" color="primary"> ${this.textTitle} </wui-text>
        ${this.templateContent()}
      </wui-flex>
    `}templateContent(){return this.imageSrc?o`<wui-image src=${this.imageSrc} alt=${this.textTitle}></wui-image>`:this.textValue?o` <wui-text variant="md-regular" color="secondary"> ${this.textValue} </wui-text>`:o`<wui-icon size="inherit" color="default" name="networkPlaceholder"></wui-icon>`}};W.styles=[$,A,M],_([k()],W.prototype,"imageSrc",void 0),_([k()],W.prototype,"textTitle",void 0),_([k()],W.prototype,"textValue",void 0),W=_([b("wui-list-content")],W);const Y=x`
  :host {
    display: flex;
    width: auto;
...
`;var K=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let X=class extends e{constructor(){super(...arguments),this.params=s.state.data?.send}render(){return o` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(e){e&&!this.params&&s.push("Networks",{network:e})}};X.styles=Y,K([k()],X.prototype,"receiverAddress",void 0),K([k({type:Object})],X.prototype,"caipNetwork",void 0),K([v()],X.prototype,"params",void 0),X=K([b("w3m-wallet-send-details")],X);const Z=x`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`;let ee=class extends e{constructor(){super(),this.unsubscribe=[],this.unsubscribe.push()}render(){return o`
    ...
    `}onCloseClick(){g.close()}};ee.styles=Q,ee=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s}([b("w3m-send-confirmed-view")],ee);export{ee as W3mSendConfirmedView,V as W3mSendSelectTokenView,J as W3mWalletSendPreviewView,z as W3mWalletSendView};
