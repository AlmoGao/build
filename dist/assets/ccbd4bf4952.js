import{dS as e,dQ as t,cZ as r,dR as o,cQ as n,dX as i,cX as s,dY as a,dU as c}from"./ccbd4bf4.js";import{a as l,c as u,r as d,e as p}from"./ccbd4bf4886.js";import"./ccbd4bf4889.js";import{r as f}from"./ccbd4bf4885.js";const w=e``;let y=class extends t{render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=r.state;return e||t?o`
      <wui-flex
        .padding=${["4","3","3","3"]}
...
`;let h=class extends t{render(){return o`
    ...
    `}};h.styles=[d,p,m],h=function(e,t,r,o){var n,i=arguments.length,s=i<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(s=(i<3?n(s):i>3?n(t,r,s):n(t,r))||s);return i>3&&s&&Object.defineProperty(t,r,s),s}([l("wui-ux-by-reown")],h);const b=u`
...
`;var g=function(e,t,r,o){var n,i=arguments.length,s=i<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(s=(i<3?n(s):i>3?n(t,r,s):n(t,r))||s);return i>3&&s&&Object.defineProperty(t,r,s),s};let x=class extends t{constructor(){super(),this.unsubscribe=[],this.remoteFeatures=r.state.remoteFeatures,this.unsubscribe.push(r.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=r.state,n=r.state.features?.legalCheckbox;return!e&&!t||n?o`
    ...
    >`:null}privacyTemplate(){const{privacyPolicyUrl:e}=r.state;return e?o`<a href=${e} target="_blank" rel="noopener noreferrer"
      >Privacy Policy</a
    >`:null}reownBrandingTemplate(e=!1){return this.remoteFeatures?.reownBranding?e?o`<wui-ux-by-reown class="branding-only"></wui-ux-by-reown>`:o`<wui-ux-by-reown></wui-ux-by-reown>`:null}};x.styles=[b],g([f()],x.prototype,"remoteFeatures",void 0),x=g([l("w3m-legal-footer")],x);
