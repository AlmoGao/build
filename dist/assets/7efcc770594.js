import{eg as e,ee as t,eX as i,dd as o,ef as r,eq as s,fp as n,h8 as a,dc as c,h9 as d,d5 as l,d6 as u,ek as p,d4 as h,el as m,db as g,em as f,d7 as b,ei as w}from"./7efcc770.js";import{r as y,n as x}from"./7efcc770529.js";import{a as v,c as $,r as k,e as R}from"./7efcc770530.js";import"./7efcc770534.js";import{e as S,n as E}from"./7efcc770536.js";import"./7efcc770531.js";import{H as A}from"./7efcc770558.js";import{o as C}from"./7efcc770410.js";import"./7efcc770535.js";import"./7efcc770528.js";import"./7efcc770532.js";import"./7efcc770533.js";import{N as T}from"./7efcc770409.js";const N=e`
  div {
    width: 100%;
  }
...
`;var I=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};const D={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},P={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let _=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};_.styles=[k,R,z],I([x()],_.prototype,"type",void 0),I([x()],_.prototype,"size",void 0),I([x()],_.prototype,"imageSrc",void 0),I([x({type:Boolean})],_.prototype,"disabled",void 0),I([x()],_.prototype,"href",void 0),I([x()],_.prototype,"text",void 0),_=I([v("wui-semantic-chip")],_);let U=class extends t{render(){return r`
    ...
    `}};U=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n}([v("w3m-upgrade-wallet-view")],U);const B=$`
  :host {
    width: 100%;
  }
...
`;var M=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let K=class extends t{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return r`
    ...
    `}templateRightContent(){return this.loading?r`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?r`<wui-tag variant="info" size="sm">Registered</wui-tag>`:r`<wui-tag variant="success" size="sm">Available</wui-tag>`}};K.styles=[k,R,B],M([x()],K.prototype,"name",void 0),M([x({type:Boolean})],K.prototype,"registered",void 0),M([x({type:Boolean})],K.prototype,"loading",void 0),M([x({type:Boolean})],K.prototype,"disabled",void 0),K=M([v("wui-account-name-suggestion-item")],K);const F=$`
  :host {
    position: relative;
    width: 100%;
...
`;var Y=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let H=class extends t{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return r`
      <wui-input-text
        value=${C(this.value)}
      ...
      ></wui-input-text>
    `}};H.styles=[k,F],Y([x()],H.prototype,"errorMessage",void 0),Y([x({type:Boolean})],H.prototype,"disabled",void 0),Y([x()],H.prototype,"value",void 0),Y([x({type:Boolean})],H.prototype,"loading",void 0),Y([x({attribute:!1})],H.prototype,"onKeyDown",void 0),H=Y([v("wui-ens-input")],H);const L=$`
  wui-flex {
    width: 100%;
  }
...
`;var V=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let W=class extends t{constructor(){super(),this.formRef=S(),this.usubscribe=[],this.name="",this.error="",this.loading=d.state.loading,this.suggestions=d.state.suggestions,this.profileName=l.state.profileName,this.onDebouncedNameInputChange=u.debounce(e=>{e.length<4?this.error="Name must be at least 4 characters long":A.isValidReownName(e)?(this.error="",d.getSuggestions(e)):this.error="The value is not a valid username"}),this.usubscribe.push(d.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),l.subscribeKey("profileName",e=>{this.profileName=e,e&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return r`
      <wui-flex
    ...
    </wui-flex>`}isAllowedToSubmit(e){const t=e.split(".")?.[0],i=this.suggestions.find(e=>e.name?.split(".")?.[0]===t&&e.registered);return!this.loading&&!this.error&&!this.profileName&&t&&d.validateName(t)&&!i}async onSubmitName(e){try{if(!this.isAllowedToSubmit(e))return;h.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:m(g.state.activeChain)===f.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}}),await d.registerName(e),h.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:m(g.state.activeChain)===f.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}})}catch(t){b.showError(t.message),h.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:m(g.state.activeChain)===f.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e,error:u.parseError(t)}})}}onEnterKey(e){if("Enter"===e.key&&this.name&&this.isAllowedToSubmit(this.name)){const e=`${this.name}${p.WC_NAME_SUFFIX}`;this.onSubmitName(e)}}};W.styles=L,V([x()],W.prototype,"errorMessage",void 0),V([y()],W.prototype,"name",void 0),V([y()],W.prototype,"error",void 0),V([y()],W.prototype,"loading",void 0),V([y()],W.prototype,"suggestions",void 0),V([y()],W.prototype,"profileName",void 0),W=V([v("w3m-register-account-name-view")],W);const G=e`
...
`;let q=class extends t{render(){return r`
      ...
      >
        ...
        <wui-link
          @click=${()=>{u.openHref(T.URLS.FAQ,"_blank")}}
        >
          Learn more
