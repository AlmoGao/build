import{dT as e,dU as t,cS as i,cU as n,g8 as o,eT as a,cM as r,cN as s,ex as c,dV as l,cL as d,f2 as u,e3 as h,dZ as p,dX as w,cT as m,cO as g,d_ as b,d$ as f,dY as y,gl as v,hS as x,hT as $,hU as k,gI as C,gF as S,gH as R,hV as E,e1 as I,fX as T,fW as A,fV as O,eU as N,hW as P,hX as j,hY as D,hZ as L,gG as W}from"./acd90090.js";import{n as z,r as _,a as U}from"./acd900901007.js";import{o as B}from"./acd90090845.js";import{c as F,r as M,e as V,a as K,U as H}from"./acd900901008.js";import"./acd900901012.js";import"./acd900901009.js";import"./acd900901020.js";import"./acd900901010.js";import{a as q,W as G}from"./acd900901075.js";import"./acd900901006.js";import"./acd900901021.js";import{e as Y,n as X}from"./acd900901014.js";import{H as Q}from"./acd900901040.js";import"./acd900901023.js";import"./acd900901011.js";import"./acd900901053.js";import{M as Z}from"./acd900901041.js";import"./acd900901042.js";import"./acd900901013.js";import"./acd900901016.js";import"./acd900901067.js";import"./acd900901015.js";import{O as J}from"./acd900901066.js";import{e as ee}from"./acd900901057.js";import"./acd900901055.js";import{N as te}from"./acd90090844.js";import"./acd900901079.js";import"./acd900902.js";import"./acd900903.js";const ie=F`
  :host {
    display: block;
  }
...
`;var Qe=function(e,t,i,n){var o,a=arguments.length,r=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(r=(a<3?o(r):a>3?o(t,i,r):o(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let Ze=class extends e{constructor(){super(...arguments),this.dollars="0",this.pennies="00"}render(){return t`<span>$${this.dollars}<span class="pennies">.${this.pennies}</span></span>`}};Ze.styles=[M,Xe],Qe([z()],Ze.prototype,"dollars",void 0),Qe([z()],Ze.prototype,"pennies",void 0),Ze=Qe([K("wui-balance")],Ze);const Je=F`
  :host {
    display: inline-flex;
    justify-content: center;
    align-items: center;
...
`;var Zt=function(e,t,i,n){var o,a=arguments.length,r=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(r=(a<3?o(r):a>3?o(t,i,r):o(t,i))||r);return a>3&&r&&Object.defineProperty(t,i,r),r};let Jt=class extends e{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.visible=!1,this.imageSrc=void 0,this.imageLoading=!1,this.isImpressed=!1,this.explorerId="",this.walletQuery="",this.certified=!1,this.wallet=void 0,this.observer=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?(this.visible=!0,this.fetchImageSrc(),this.sendImpressionEvent()):this.visible=!1})},{threshold:.01})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){const e="certified"===this.wallet?.badge_type;return t`
      <button>
        ${this.imageTemplate()}
    ...
    `}shimmerTemplate(){return t`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}async fetchImageSrc(){this.wallet&&(this.imageSrc=a.getWalletImage(this.wallet),this.imageSrc||(this.imageLoading=!0,this.imageSrc=await a.fetchWalletImage(this.wallet.image_id),this.imageLoading=!1))}sendImpressionEvent(){this.wallet&&!this.isImpressed&&(this.isImpressed=!0,d.sendEvent({type:"track",event:"WALLET_IMPRESSION",properties:{name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.explorerId,view:w.state.view,query:this.walletQuery,certified:this.certified}}))}};Jt.styles=Qt,Zt([_()],Jt.prototype,"visible",void 0),Zt([_()],Jt.prototype,"imageSrc",void 0),Zt([_()],Jt.prototype,"imageLoading",void 0),Zt([_()],Jt.prototype,"isImpressed",void 0),Zt([z()],Jt.prototype,"explorerId",void 0),Zt([z()],Jt.prototype,"walletQuery",void 0),Zt([z()],Jt.prototype,"certified",void 0),Zt([z({type:Object})],Jt.prototype,"wallet",void 0),Jt=Zt([K("w3m-all-wallets-list-item")],Jt);const ei=F`
  wui-grid {
...
`;let fo=class extends e{constructor(){super(...arguments),this.dappImageUrl=n.state.metadata?.icons,this.walletImageUrl=r.state.connectedWalletInfo?.icon}firstUpdated(){const e=this.shadowRoot?.querySelectorAll("wui-visual-thumbnail");e?.[0]&&this.createAnimation(e[0],"translate(18px)"),e?.[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){return t`
    ...
    `}async onSign(){this.isSigning=!0;try{await W.requestSignMessage()}catch(e){if(e instanceof Error&&e.message.includes("OTP is required"))return g.showError({message:"Something went wrong. We need to verify your account again."}),void w.replace("DataCapture");throw e}finally{this.isSigning=!1}}async onCancel(){this.isCancelling=!0,await W.cancelSignMessage().finally(()=>this.isCancelling=!1)}};yo([_()],vo.prototype,"isCancelling",void 0),yo([_()],vo.prototype,"isSigning",void 0),vo=yo([K("w3m-siwx-sign-message-view")],vo);export{ce as AppKitAccountButton,pe as AppKitButton,ve as AppKitConnectButton,Ie as AppKitNetworkButton,se as W3mAccountButton,De as W3mAccountSettingsView,bt as W3mAccountView,ci as W3mAllWalletsView,he as W3mButton,En as W3mChooseAccountNameView,ye as W3mConnectButton,Gi as W3mConnectView,Ln as W3mConnectWalletsView,an as W3mConnectingExternalView,cn as W3mConnectingMultiChainView,Cn as W3mConnectingWcBasicView,$n as W3mConnectingWcView,In as W3mDownloadsView,q as W3mFooter,Tn as W3mGetWalletView,Ee as W3mNetworkButton,Hn as W3mNetworkSwitchView,Zn as W3mNetworksView,jt as W3mProfileWalletsView,G as W3mRouter,vo as W3mSIWXSignMessageView,io as W3mSwitchActiveChainView,so as W3mUnsupportedChainView,po as W3mWalletCompatibleNetworksView,oo as W3mWhatIsANetworkView,Pn as W3mWhatIsAWalletView};
