import{dT as t,dU as e}from"./59977a62.js";import{n as i}from"./59977a621007.js";import{o}from"./59977a62845.js";import{e as n,n as r}from"./59977a621014.js";import{c as a,r as s,e as p,a as u}from"./59977a621008.js";const l=a`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var c=function(t,e,i,o){var n,r=arguments.length,a=r<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(n=t[s])&&(a=(r<3?n(a):r>3?n(e,i,a):n(e,i))||a);return r>3&&a&&Object.defineProperty(e,i,a),a};let d=class extends t{constructor(){super(...arguments),this.inputElementRef=n(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return e` <div class="wui-input-text-container">
      ...
      </button>`:null}templateError(){return this.errorText?e`<wui-text variant="sm-regular" color="error">${this.errorText}</wui-text>`:null}templateWarning(){return this.warningText?e`<wui-text variant="sm-regular" color="warning">${this.warningText}</wui-text>`:null}dispatchInputChangeEvent(){this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};d.styles=[s,p,l],c([i()],d.prototype,"icon",void 0),c([i({type:Boolean})],d.prototype,"disabled",void 0),c([i({type:Boolean})],d.prototype,"loading",void 0),c([i()],d.prototype,"placeholder",void 0),c([i()],d.prototype,"type",void 0),c([i()],d.prototype,"value",void 0),c([i()],d.prototype,"errorText",void 0),c([i()],d.prototype,"warningText",void 0),c([i()],d.prototype,"onSubmit",void 0),c([i()],d.prototype,"size",void 0),c([i({attribute:!1})],d.prototype,"onKeyDown",void 0),d=c([u("wui-input-text")],d);
