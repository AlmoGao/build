import{dP as t,dQ as e}from"./6db743d6.js";import{n as i}from"./6db743d6937.js";import{o}from"./6db743d6779.js";import{e as n,n as r}from"./6db743d6944.js";import{c as a,r as s,e as p,a as u}from"./6db743d6938.js";const d=a`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var l=function(t,e,i,o){var n,r=arguments.length,a=r<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(n=t[s])&&(a=(r<3?n(a):r>3?n(e,i,a):n(e,i))||a);return r>3&&a&&Object.defineProperty(e,i,a),a};let c=class extends t{constructor(){super(...arguments),this.inputElementRef=n(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return e` <div class="wui-input-text-container">
      ...
      </button>`:null}templateError(){return this.errorText?e`<wui-text variant="sm-regular" color="error">${this.errorText}</wui-text>`:null}templateWarning(){return this.warningText?e`<wui-text variant="sm-regular" color="warning">${this.warningText}</wui-text>`:null}dispatchInputChangeEvent(){this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};c.styles=[s,p,d],l([i()],c.prototype,"icon",void 0),l([i({type:Boolean})],c.prototype,"disabled",void 0),l([i({type:Boolean})],c.prototype,"loading",void 0),l([i()],c.prototype,"placeholder",void 0),l([i()],c.prototype,"type",void 0),l([i()],c.prototype,"value",void 0),l([i()],c.prototype,"errorText",void 0),l([i()],c.prototype,"warningText",void 0),l([i()],c.prototype,"onSubmit",void 0),l([i()],c.prototype,"size",void 0),l([i({attribute:!1})],c.prototype,"onKeyDown",void 0),c=l([u("wui-input-text")],c);
