import{e5 as e,d5 as t,da as i,ea as n,gL as r,e6 as o,e9 as s,dd as a,d4 as c,d6 as l,db as u,eg as d,f0 as h,eb as p,d3 as f,ec as m,ed as w,eB as g}from"./6c11ffa5.js";import{n as k,r as v}from"./6c11ffa5283.js";import{c as b,a as x,U as y,r as $,e as A}from"./6c11ffa5284.js";import{e as T,n as C}from"./6c11ffa5290.js";import"./6c11ffa5286.js";import"./6c11ffa5295.js";import"./6c11ffa5287.js";import"./6c11ffa5294.js";import{S as P}from"./6c11ffa5293.js";import"./6c11ffa5289.js";import"./6c11ffa5318.js";import"./6c11ffa5288.js";import"./6c11ffa5296.js";import{o as R}from"./6c11ffa5188.js";import"./6c11ffa5285.js";import"./6c11ffa5292.js";const N=b`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let O=class extends e{constructor(){super(...arguments),this.readOnly=!1}render(){const e=this.readOnly||!this.token;return o` <wui-flex
    ...
    </wui-flex>`}onInputChange(e){r.setTokenAmount(e.detail)}onMaxClick(){if(this.token){const e=a.bigNumber(this.token.quantity.numeric);r.setTokenAmount(Number(e.toFixed(20)))}}onBuyClick(){s.push("OnRampProviders")}};O.styles=I,B([k({type:Object})],O.prototype,"token",void 0),B([k({type:Boolean})],O.prototype,"readOnly",void 0),B([k({type:Number})],O.prototype,"sendTokenAmount",void 0),O=B([x("w3m-input-token")],O);const E=b`
  :host {
    display: block;
  }
...
`;var H=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let V=class extends e{constructor(){super(),this.unsubscribe=[],this.tokenBalances=r.state.tokenBalances,this.search="",this.onDebouncedSearch=t.debounce(e=>{this.search=e}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(r.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return o`
    ...
    `}onBuyClick(){s.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){r.setToken(e),r.setTokenAmount(void 0),s.goBack()}};V.styles=U,H([v()],V.prototype,"tokenBalances",void 0),H([v()],V.prototype,"tokens",void 0),H([v()],V.prototype,"filteredTokens",void 0),H([v()],V.prototype,"search",void 0),V=H([x("w3m-wallet-send-select-token-view")],V);const L=b`
  :host {
    height: 32px;
    display: flex;
    align-items: center;
...
`;var F=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let q=class extends e{constructor(){super(...arguments),this.text=""}render(){return o`<wui-text variant="lg-regular" color="primary">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.address?o`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?o`<wui-image src=${this.imageSrc}></wui-image>`:o`<wui-icon size="lg" color="inverse" name="networkPlaceholder"></wui-icon>`}};q.styles=[$,A,L],F([k({type:String})],q.prototype,"text",void 0),F([k({type:String})],q.prototype,"address",void 0),F([k({type:String})],q.prototype,"imageSrc",void 0),q=F([x("wui-preview-item")],q);const M=b`
  :host {
    display: flex;
...
`;var K=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let G=class extends e{constructor(){super(...arguments),this.params=s.state.data?.send}render(){return o` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(e){e&&!this.params&&s.push("Networks",{network:e})}};G.styles=Y,K([k()],G.prototype,"receiverAddress",void 0),K([k({type:Object})],G.prototype,"caipNetwork",void 0),K([v()],G.prototype,"params",void 0),G=K([x("w3m-wallet-send-details")],G);const J=b`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`;var Q=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let X=class extends e{constructor(){super(),this.unsubscribe=[],this.token=r.state.token,this.sendTokenAmount=r.state.sendTokenAmount,this.receiverAddress=r.state.receiverAddress,this.receiverProfileName=r.state.receiverProfileName,this.receiverProfileImageUrl=r.state.receiverProfileImageUrl,this.caipNetwork=i.state.activeCaipNetwork,this.loading=r.state.loading,this.params=s.state.data?.send,this.unsubscribe.push(r.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.receiverProfileImageUrl=e.receiverProfileImageUrl,this.loading=e.loading}),i.subscribeKey("activeCaipNetwork",e=>this.caipNetwork=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return o` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    >`}sendValueTemplate(){if(!this.params&&this.token&&this.sendTokenAmount){const e=this.token.price*this.sendTokenAmount;return o`<wui-text variant="md-regular" color="primary"
      ...
      >`}return null}async onSendClick(){if(this.sendTokenAmount&&this.receiverAddress)try{await r.sendToken(),this.params?s.reset("WalletSendConfirmed"):(l.showSuccess("Transaction started"),s.replace("Account"))}catch(e){let n="Failed to send transaction. Please try again.";i.state.activeChain===p.CHAIN.SOLANA&&e instanceof Error&&(n=e.message),l.showError(n),f.sendEvent({type:"track",event:"SEND_ERROR",properties:{message:t.parseError(e),isSmartAccount:m(i.state.activeChain)===w.ACCOUNT_TYPES.SMART_ACCOUNT,token:this.token?.symbol||"",amount:this.sendTokenAmount,network:i.state.activeCaipNetwork?.caipNetworkId||""}})}else l.showError("Please enter a valid amount and receiver address")}onCancelClick(){s.goBack()}};X.styles=J,Q([v()],X.prototype,"token",void 0),Q([v()],X.prototype,"sendTokenAmount",void 0),Q([v()],X.prototype,"receiverAddress",void 0),Q([v()],X.prototype,"receiverProfileName",void 0),Q([v()],X.prototype,"receiverProfileImageUrl",void 0),Q([v()],X.prototype,"caipNetwork",void 0),Q([v()],X.prototype,"loading",void 0),Q([v()],X.prototype,"params",void 0),X=Q([x("w3m-wallet-send-preview-view")],X);const Z=b`
  .icon-box {
    width: 64px;
    height: 64px;
    border-radius: 16px;
...
`;let ee=class extends e{constructor(){super(),this.unsubscribe=[],this.unsubscribe.push()}render(){return o`
    ...
    `}onCloseClick(){g.close()}};ee.styles=Z,ee=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s}([x("w3m-send-confirmed-view")],ee);export{ee as W3mSendConfirmedView,V as W3mSendSelectTokenView,X as W3mWalletSendPreviewView,z as W3mWalletSendView};
