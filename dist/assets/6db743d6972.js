import{dR as e,dP as t,dT as o,er as i,dQ as n}from"./6db743d6.js";import{n as r,r as s}from"./6db743d6937.js";import{a as d}from"./6db743d6938.js";import{T as h}from"./6db743d6973.js";const a={interpolate(e,t,o){if(2!==e.length||2!==t.length)throw new Error("inputRange and outputRange must be an array of length 2");const i=e[0]||0,n=e[1]||0,r=t[0]||0,s=t[1]||0;return o<i?r:o>n?s:(s-r)/(n-i)*(o-i)+r}},c=e`
  :host {
    width: 100%;
    display: block;
  }
