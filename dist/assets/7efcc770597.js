import{ee as e,db as t,de as o,ef as i,dc as n,d4 as r,ei as s,d5 as a,d6 as l,eX as c,el as u,em as p}from"./7efcc770.js";import{r as d,n as h}from"./7efcc770529.js";import{c as w,a as g,r as m,e as k}from"./7efcc770530.js";import"./7efcc770536.js";import"./7efcc770532.js";import{M as f}from"./7efcc770559.js";import"./7efcc770560.js";import{S as b}from"./7efcc770539.js";import"./7efcc770538.js";import"./7efcc770540.js";import"./7efcc770535.js";import"./7efcc770534.js";import"./7efcc770531.js";import"./7efcc770410.js";const x={numericInputKeyDown(e,t,o){const i=e.metaKey||e.ctrlKey,n=e.key,r=n.toLocaleLowerCase(),s=","===n,a="."===n,l=n>="0"&&n<="9";!i&&("a"===r||"c"===r||"v"===r||"x"===r)&&e.preventDefault(),"0"!==t||s||a||"0"!==n||e.preventDefault(),"0"===t&&l&&(o(n),e.preventDefault()),(s||a)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),l||["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"].includes(n)||a||s||e.preventDefault()}},T=w`
  :host {
    width: 100%;
  }
...
`;var j=function(e,t,o,i){var n,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r<3?n(s):r>3?n(t,o,s):n(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let E=class extends e{constructor(){super(),this.unsubscribe=[],this.initialParams=s.state.data?.swap,this.detailsOpen=!1,this.caipAddress=a.state.caipAddress,this.caipNetworkId=t.state.activeCaipNetwork?.caipNetworkId,this.initialized=b.state.initialized,this.loadingQuote=b.state.loadingQuote,this.loadingPrices=b.state.loadingPrices,this.loadingTransaction=b.state.loadingTransaction,this.sourceToken=b.state.sourceToken,this.sourceTokenAmount=b.state.sourceTokenAmount,this.sourceTokenPriceInUSD=b.state.sourceTokenPriceInUSD,this.toToken=b.state.toToken,this.toTokenAmount=b.state.toTokenAmount,this.toTokenPriceInUSD=b.state.toTokenPriceInUSD,this.inputError=b.state.inputError,this.fetchError=b.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document?.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{this.sourceToken&&this.toToken&&(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=l.debounce(async()=>{await b.swapTokens()},200),t.subscribeKey("activeCaipNetwork",e=>this.onCaipNetworkChange({newCaipNetwork:e,resetSwapState:!0,initializeSwapState:!1})),a.subscribeKey("caipAddress",e=>this.onCaipAddressChange({newCaipAddress:e,resetSwapState:!0,initializeSwapState:!1})),this.unsubscribe.push(t.subscribeKey("activeCaipNetwork",e=>this.onCaipNetworkChange({newCaipNetwork:e,resetSwapState:!1,initializeSwapState:!0})),a.subscribeKey("caipAddress",e=>this.onCaipAddressChange({newCaipAddress:e,resetSwapState:!1,initializeSwapState:!0})),c.subscribeKey("open",e=>{e||b.resetState()}),s.subscribeKey("view",e=>{e.includes("Swap")||b.resetValues()}),b.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.fetchError=e.fetchError,e.sourceToken&&e.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){b.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval),document?.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return i`
    ...
    `}templateTokenInput(e,t){const n=b.state.myTokensWithBalance?.find(e=>e?.address===t?.address),r="toToken"===e?this.toTokenAmount:this.sourceTokenAmount,s="toToken"===e?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,a=o.parseLocalStringToNumber(r)*s;return i`<w3m-swap-input
    ...
    ></w3m-swap-input>`}onSetMaxValue(e,t){const i=o.bigNumber(t||"0");this.handleChangeAmount(e,i.gt(0)?i.toFixed(20):"0")}templateDetails(){return this.sourceToken&&this.toToken&&!this.inputError?i`<w3m-swap-details .detailsOpen=${this.detailsOpen}></w3m-swap-details>`:null}handleChangeAmount(e,t){b.clearError(),"sourceToken"===e?b.setSourceTokenAmount(t):b.setToTokenAmount(t),this.onDebouncedGetSwapCalldata()}templateActionButton(){const e=!this.toToken||!this.sourceToken,t=!this.sourceTokenAmount,o=this.loadingQuote||this.loadingPrices||this.loadingTransaction,n=o||e||t||this.inputError;return i` <wui-flex gap="2">
      <wui-button
    ...
    </wui-flex>`}onSwitchTokens(){b.switchTokens()}async onSwapPreview(){this.fetchError&&await b.swapTokens(),r.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:this.sourceToken?.symbol||"",swapToToken:this.toToken?.symbol||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:u(t.state.activeChain)===p.ACCOUNT_TYPES.SMART_ACCOUNT}}),s.push("SwapPreview")}async handleSwapParameters(){if(this.initialParams){if(!b.state.initialized){const e=new Promise(e=>{const t=b.subscribeKey("initialized",o=>{o&&(t?.(),e())})});await e}await this.setSwapParameters(this.initialParams)}}async setSwapParameters({amount:e,fromToken:t,toToken:o}){if(!b.state.tokens||!b.state.myTokensWithBalance){const e=new Promise(e=>{const t=b.subscribeKey("myTokensWithBalance",o=>{o&&o.length>0&&(t?.(),e())});setTimeout(()=>{t?.(),e()},5e3)});await e}const i=[...b.state.tokens||[],...b.state.myTokensWithBalance||[]];if(t){const e=i.find(e=>e.symbol.toLowerCase()===t.toLowerCase());e&&b.setSourceToken(e)}if(o){const e=i.find(e=>e.symbol.toLowerCase()===o.toLowerCase());e&&b.setToToken(e)}e&&!isNaN(Number(e))&&b.setSourceTokenAmount(e)}onCaipAddressChange({newCaipAddress:e,resetSwapState:t,initializeSwapState:o}){this.caipAddress!==e&&(this.caipAddress=e,t&&b.resetState(),o&&b.initializeState())}onCaipNetworkChange({newCaipNetwork:e,resetSwapState:t,initializeSwapState:o}){this.caipNetworkId!==e?.caipNetworkId&&(this.caipNetworkId=e?.caipNetworkId,t&&b.resetState(),o&&b.initializeState())}};E.styles=R,j([h({type:Object})],E.prototype,"initialParams",void 0),j([d()],E.prototype,"interval",void 0),j([d()],E.prototype,"detailsOpen",void 0),j([d()],E.prototype,"caipAddress",void 0),j([d()],E.prototype,"caipNetworkId",void 0),j([d()],E.prototype,"initialized",void 0),j([d()],E.prototype,"loadingQuote",void 0),j([d()],E.prototype,"loadingPrices",void 0),j([d()],E.prototype,"loadingTransaction",void 0),j([d()],E.prototype,"sourceToken",void 0),j([d()],E.prototype,"sourceTokenAmount",void 0),j([d()],E.prototype,"sourceTokenPriceInUSD",void 0),j([d()],E.prototype,"toToken",void 0),j([d()],E.prototype,"toTokenAmount",void 0),j([d()],E.prototype,"toTokenPriceInUSD",void 0),j([d()],E.prototype,"inputError",void 0),j([d()],E.prototype,"fetchError",void 0),j([d()],E.prototype,"lastTokenPriceUpdate",void 0),E=j([g("w3m-swap-view")],E);const L=w`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`;var U=function(e,t,o,i){var n,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r<3?n(s):r>3?n(t,o,s):n(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let N=class extends e{constructor(){super(),this.unsubscribe=[],this.detailsOpen=!0,this.approvalTransaction=b.state.approvalTransaction,this.swapTransaction=b.state.swapTransaction,this.sourceToken=b.state.sourceToken,this.sourceTokenAmount=b.state.sourceTokenAmount??"",this.sourceTokenPriceInUSD=b.state.sourceTokenPriceInUSD,this.toToken=b.state.toToken,this.toTokenAmount=b.state.toTokenAmount??"",this.toTokenPriceInUSD=b.state.toTokenPriceInUSD,this.caipNetwork=t.state.activeCaipNetwork,this.balanceSymbol=a.state.balanceSymbol,this.inputError=b.state.inputError,this.loadingQuote=b.state.loadingQuote,this.loadingApprovalTransaction=b.state.loadingApprovalTransaction,this.loadingBuildTransaction=b.state.loadingBuildTransaction,this.loadingTransaction=b.state.loadingTransaction,this.unsubscribe.push(a.subscribeKey("balanceSymbol",e=>{this.balanceSymbol!==e&&s.goBack()}),t.subscribeKey("activeCaipNetwork",e=>{this.caipNetwork!==e&&(this.caipNetwork=e)}),b.subscribe(e=>{this.approvalTransaction=e.approvalTransaction,this.swapTransaction=e.swapTransaction,this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.sourceTokenAmount=e.sourceTokenAmount??"",this.toTokenAmount=e.toTokenAmount??"",this.inputError=e.inputError,e.inputError&&s.goBack(),this.loadingQuote=e.loadingQuote,this.loadingApprovalTransaction=e.loadingApprovalTransaction,this.loadingBuildTransaction=e.loadingBuildTransaction,this.loadingTransaction=e.loadingTransaction}))}firstUpdated(){b.getTransaction(),this.refreshTransaction()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval)}render(){return i`
      <wui-flex flexDirection="column" .padding=${["0","4","4","4"]} gap="3">
        ${this.templateSwap()}
      </wui-flex>
    `}refreshTransaction(){this.interval=setInterval(()=>{b.getApprovalLoadingState()||b.getTransaction()},1e4)}templateSwap(){const e=`${o.formatNumberToLocalString(parseFloat(this.sourceTokenAmount))} ${this.sourceToken?.symbol}`,t=`${o.formatNumberToLocalString(parseFloat(this.toTokenAmount))} ${this.toToken?.symbol}`,n=parseFloat(this.sourceTokenAmount)*this.sourceTokenPriceInUSD,r=parseFloat(this.toTokenAmount)*this.toTokenPriceInUSD,s=o.formatNumberToLocalString(n),a=o.formatNumberToLocalString(r),l=this.loadingQuote||this.loadingBuildTransaction||this.loadingTransaction||this.loadingApprovalTransaction;return i`
