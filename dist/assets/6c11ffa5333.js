import{d1 as e,dh as t,di as o,e5 as s,e6 as c,dc as r}from"./6c11ffa5.js";import{n as i,r as a}from"./6c11ffa5283.js";import{c as n,r as l,a as d}from"./6c11ffa5284.js";import{o as h}from"./6c11ffa5188.js";import{e as p,n as b}from"./6c11ffa5290.js";const u=e({isLegalCheckboxChecked:!1}),k={state:u,subscribe:e=>o(u,()=>e(u)),subscribeKey:(e,o)=>t(u,e,o),setIsLegalCheckboxChecked(e){u.isLegalCheckboxChecked=e}},x=n`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var f=function(e,t,o,s){var c,r=arguments.length,i=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,o):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,o,s);else for(var a=e.length-1;a>=0;a--)(c=e[a])&&(i=(r<3?c(i):r>3?c(t,o,i):c(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};const y={lg:"md",md:"sm",sm:"sm"};let g=class extends s{constructor(){super(...arguments),this.inputElementRef=p(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const e=y[this.size];return c`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("checkboxChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};g.styles=[l,x],f([i({type:Boolean})],g.prototype,"checked",void 0),f([i({type:Boolean})],g.prototype,"disabled",void 0),f([i()],g.prototype,"size",void 0),g=f([d("wui-checkbox")],g);const m=n`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
