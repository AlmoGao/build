import{eX as e,he as t,ei as o,ej as i,ee as a,ef as r,eo as s,db as n,fo as c,hb as l,eW as d,d4 as p,dd as h,eq as u,d5 as m,eg as w,d7 as b,hf as g,fp as f,hg as y,d6 as v,ek as k}from"./7efcc770.js";import{n as x,r as $}from"./7efcc770529.js";import{o as C}from"./7efcc770410.js";import{c as S,r as P,a as R,e as I,U as O,i as N}from"./7efcc770530.js";import"./7efcc770534.js";import{H as W}from"./7efcc770558.js";import"./7efcc770531.js";import"./7efcc770532.js";import"./7efcc770560.js";import"./7efcc770593.js";import{S as A}from"./7efcc770539.js";import"./7efcc770587.js";import"./7efcc770533.js";const E={isUnsupportedChainView:()=>"UnsupportedChain"===o.state.view||"SwitchNetwork"===o.state.view&&o.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void e.shake();await t.isSIWXCloseDisabled()?e.shake():("DataCapture"!==o.state.view&&"DataCaptureOtpConfirm"!==o.state.view||i.disconnect(),e.close())}},z=S`
  :host {
    display: block;
...
`;var T=function(e,t,o,i){var a,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,o,s):a(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};const B={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let L=class extends a{constructor(){super(...arguments),this.message="",this.type="info"}render(){return r`
    ...
    `}onClose(){s.close()}};L.styles=[P,D],T([x()],L.prototype,"message",void 0),T([x()],L.prototype,"type",void 0),L=T([R("wui-alertbar")],L);const H=S`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`;var U=function(e,t,o,i){var a,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,o,s):a(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};const V={info:{backgroundColor:"fg-350",iconColor:"fg-325",icon:"info"},success:{backgroundColor:"success-glass-reown-020",iconColor:"success-125",icon:"checkmark"},warning:{backgroundColor:"warning-glass-reown-020",iconColor:"warning-100",icon:"warningCircle"},error:{backgroundColor:"error-glass-reown-020",iconColor:"error-125",icon:"warning"}};let K=class extends a{constructor(){super(),this.unsubscribe=[],this.open=s.state.open,this.onOpen(!0),this.unsubscribe.push(s.subscribeKey("open",e=>{this.open=e,this.onOpen(!1)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t}=s.state,o=V[t];return r`
      <wui-alertbar
        ...
        type=${t}
      ></wui-alertbar>
    `}onOpen(e){this.open?(this.animate([{opacity:0,transform:"scale(0.85)"},{opacity:1,transform:"scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: auto"):e||(this.animate([{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: none")}};K.styles=H,U([$()],K.prototype,"open",void 0),K=U([R("w3m-alertbar")],K);const X=S`
  :host {
    position: relative;
  }
...
`;var F=function(e,t,o,i){var a,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,o,s):a(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let Y=class extends a{constructor(){super(...arguments),this.icon="card",this.variant="primary",this.type="accent",this.size="md",this.fullWidth=!1,this.disabled=!1}render(){return r`<button
    ...
    </button>`}};Y.styles=[P,I,X],F([x()],Y.prototype,"icon",void 0),F([x()],Y.prototype,"variant",void 0),F([x()],Y.prototype,"type",void 0),F([x()],Y.prototype,"size",void 0),F([x({type:Boolean})],Y.prototype,"fullWidth",void 0),F([x({type:Boolean})],Y.prototype,"disabled",void 0),Y=F([R("wui-icon-button")],Y);const _=S`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var M=function(e,t,o,i){var a,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,o,s):a(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};const q={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},G={lg:"lg",md:"md",sm:"sm"};let J=class extends a{constructor(){super(...arguments),this.imageSrc="",this.text="",this.size="lg",this.type="text-dropdown",this.disabled=!1}render(){return r`<button ?disabled=${this.disabled} data-size=${this.size} data-type=${this.type}>
      ${this.imageTemplate()} ${this.textTemplate()}
      <wui-flex class="right-icon-container">
        <wui-icon name="chevronBottom"></wui-icon>
      </wui-flex>
    </button>`}textTemplate(){const e=q[this.size];return this.text?r`<wui-text color="primary" variant=${e}>${this.text}</wui-text>`:null}imageTemplate(){if(this.imageSrc)return r`<wui-image src=${this.imageSrc} alt="select visual"></wui-image>`;const e=G[this.size];return r` <wui-flex class="left-icon-container">
      <wui-icon size=${e} name="networkPlaceholder"></wui-icon>
    </wui-flex>`}};J.styles=[P,I,_],M([x()],J.prototype,"imageSrc",void 0),M([x()],J.prototype,"text",void 0),M([x()],J.prototype,"size",void 0),M([x()],J.prototype,"type",void 0),M([x({type:Boolean})],J.prototype,"disabled",void 0),J=M([R("wui-select")],J);const Q=S`
  :host {
    height: 60px;
  }
...
`;var ye=function(e,t,o,i){var a,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,o,s):a(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let ve=class extends a{constructor(){super(...arguments),this.resizeObserver=void 0,this.transitionDuration="0.15s",this.transitionFunction="",this.history="",this.view="",this.setView=void 0,this.viewDirection="",this.historyState="",this.previousHeight="0px"}updated(e){if(e.has("history")){const e=this.history;""!==this.historyState&&this.historyState!==e&&this.onViewChange(e)}e.has("transitionDuration")&&this.style.setProperty("--local-duration",this.transitionDuration),e.has("transitionFunction")&&this.style.setProperty("--local-transition",this.transitionFunction)}firstUpdated(){this.transitionFunction&&this.style.setProperty("--local-transition",this.transitionFunction),this.style.setProperty("--local-duration",this.transitionDuration),this.historyState=this.history,this.resizeObserver=new ResizeObserver(e=>{for(const t of e)if(t.target===this.getWrapper()){let e=t.contentRect.height;const o=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--apkt-footer-height")||"0");e=e+o,this.style.setProperty("--local-border-bottom-radius",o?"var(--apkt-borderRadius-5)":"0px"),this.style.setProperty("--local-container-height",`${e}px`),"0px"!==this.previousHeight&&this.style.setProperty("--local-duration-height",this.transitionDuration),this.previousHeight=`${e}px`}}),this.resizeObserver.observe(this.getWrapper())}disconnectedCallback(){const e=this.getWrapper();e&&this.resizeObserver&&this.resizeObserver.unobserve(e)}render(){return r`
    ...
    `}onViewChange(e){const t=e.split(",").filter(Boolean),o=this.historyState.split(",").filter(Boolean),i=o.length,a=t.length,r=t[t.length-1]||"",s=O.cssDurationToNumber(this.transitionDuration);let n="";a>i?n="next":a<i?n="prev":a===i&&t[a-1]!==o[i-1]&&(n="next"),this.viewDirection=`${n}-${r}`,setTimeout(()=>{this.historyState=e,this.setView?.(r)},s),setTimeout(()=>{this.viewDirection=""},2*s)}getWrapper(){return this.shadowRoot?.querySelector("div.page")}};ve.styles=[fe],ye([x({type:String})],ve.prototype,"transitionDuration",void 0),ye([x({type:String})],ve.prototype,"transitionFunction",void 0),ye([x({type:String})],ve.prototype,"history",void 0),ye([x({type:String})],ve.prototype,"view",void 0),ye([x({attribute:!1})],ve.prototype,"setView",void 0),ye([$()],ve.prototype,"viewDirection",void 0),ye([$()],ve.prototype,"historyState",void 0),ye([$()],ve.prototype,"previousHeight",void 0),ve=ye([R("w3m-router-container")],ve);export{me as AppKitModal,ge as W3mListWallet,ue as W3mModal,he as W3mModalBase,ve as W3mRouterContainer};
