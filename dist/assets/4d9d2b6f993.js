import{dS as e,dQ as t,dU as o,eu as i,dR as n}from"./4d9d2b6f.js";import{n as r,r as s}from"./4d9d2b6f958.js";import{a as d}from"./4d9d2b6f959.js";import{T as h}from"./4d9d2b6f994.js";const a={interpolate(e,t,o){if(2!==e.length||2!==t.length)throw new Error("inputRange and outputRange must be an array of length 2");const i=e[0]||0,n=e[1]||0,r=t[0]||0,s=t[1]||0;return o<i?r:o>n?s:(s-r)/(n-i)*(o-i)+r}},c=e`
  :host {
    width: 100%;
    display: block;
  }
