import{dS as e,dW as t,dT as i,cL as a}from"./845b7756.js";import{r,n as o}from"./845b7756997.js";import{c as n,a as s,r as l,e as c}from"./845b7756998.js";import"./845b77561057.js";import{H as w}from"./845b77561030.js";import{o as m}from"./845b7756832.js";import"./845b77561000.js";import"./845b77561002.js";const u=n`
  :host {
    display: block;
  }
...
`;var x=function(e,t,i,a){var r,o=arguments.length,n=o<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,a);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let S=class extends e{constructor(){super(...arguments),this.walletImages=[]}render(){const e=this.walletImages.length<4;return i`${this.walletImages.slice(0,4).map(({src:e,walletName:t})=>i`
          <wui-wallet-image
            size="sm"
            imageSrc=${e}
            name=${m(t)}
          ></wui-wallet-image>
        `)}
    ${e?[...Array(4-this.walletImages.length)].map(()=>i` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};S.styles=[l,k],x([o({type:Array})],S.prototype,"walletImages",void 0),S=x([s("wui-all-wallets-image")],S);const $=n`
  :host {
    width: 100%;
  }
