import{cJ as e,cZ as t,c_ as o,dS as s,dT as c,cU as r}from"./845b7756.js";import{n as i,r as a}from"./845b7756997.js";import{c as n,r as l,a as d}from"./845b7756998.js";import{o as h}from"./845b7756832.js";import{e as p,n as b}from"./845b77561004.js";const u=e({isLegalCheckboxChecked:!1}),k={state:u,subscribe:e=>o(u,()=>e(u)),subscribeKey:(e,o)=>t(u,e,o),setIsLegalCheckboxChecked(e){u.isLegalCheckboxChecked=e}},x=n`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var y=function(e,t,o,s){var c,r=arguments.length,i=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,o):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,o,s);else for(var a=e.length-1;a>=0;a--)(c=e[a])&&(i=(r<3?c(i):r>3?c(t,o,i):c(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};const g={lg:"md",md:"sm",sm:"sm"};let f=class extends s{constructor(){super(...arguments),this.inputElementRef=p(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const e=g[this.size];return c`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("checkboxChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};f.styles=[l,x],y([i({type:Boolean})],f.prototype,"checked",void 0),y([i({type:Boolean})],f.prototype,"disabled",void 0),y([i()],f.prototype,"size",void 0),f=y([d("wui-checkbox")],f);const m=n`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
