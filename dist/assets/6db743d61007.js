import{dR as e,dP as t,er as i,cV as o,dQ as r,d$ as s,eM as n,f_ as a,cU as d,f$ as c,cN as l,cO as u,dV as p,cM as h,dW as m,cT as g,dX as b,cP as f,dT as w}from"./6db743d6.js";import{r as y,n as x}from"./6db743d6937.js";import{a as v,c as $,r as k,e as R}from"./6db743d6938.js";import"./6db743d6942.js";import{e as S,n as E}from"./6db743d6944.js";import"./6db743d6939.js";import{H as A}from"./6db743d6971.js";import{o as T}from"./6db743d6779.js";import"./6db743d6943.js";import"./6db743d6936.js";import"./6db743d6940.js";import"./6db743d6941.js";import{N as j}from"./6db743d6778.js";import"./6db743d62.js";import"./6db743d63.js";const C=e`
  div {
    width: 100%;
  }
...
`;var I=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};const P={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},D={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let _=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
      <a
        rel="noreferrer"
        target="_blank"
        href=${this.href}
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};_.styles=[k,R,z],I([x()],_.prototype,"type",void 0),I([x()],_.prototype,"size",void 0),I([x()],_.prototype,"imageSrc",void 0),I([x({type:Boolean})],_.prototype,"disabled",void 0),I([x()],_.prototype,"href",void 0),I([x()],_.prototype,"text",void 0),_=I([v("wui-semantic-chip")],_);let M=class extends t{render(){return r`
    ...
    `}};M=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n}([v("w3m-upgrade-wallet-view")],M);const U=$`
  :host {
    width: 100%;
  }
...
`;var B=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let K=class extends t{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return r`
    ...
    `}templateRightContent(){return this.loading?r`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?r`<wui-tag variant="info" size="sm">Registered</wui-tag>`:r`<wui-tag variant="success" size="sm">Available</wui-tag>`}};K.styles=[k,R,U],B([x()],K.prototype,"name",void 0),B([x({type:Boolean})],K.prototype,"registered",void 0),B([x({type:Boolean})],K.prototype,"loading",void 0),B([x({type:Boolean})],K.prototype,"disabled",void 0),K=B([v("wui-account-name-suggestion-item")],K);const F=$`
  :host {
    position: relative;
    width: 100%;
...
`;var V=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let Y=class extends t{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return r`
      <wui-input-text
        value=${T(this.value)}
      ...
      ></wui-input-text>
    `}};Y.styles=[k,F],V([x()],Y.prototype,"errorMessage",void 0),V([x({type:Boolean})],Y.prototype,"disabled",void 0),V([x()],Y.prototype,"value",void 0),V([x({type:Boolean})],Y.prototype,"loading",void 0),V([x({attribute:!1})],Y.prototype,"onKeyDown",void 0),Y=V([v("wui-ens-input")],Y);const W=$`
  wui-flex {
    width: 100%;
  }
