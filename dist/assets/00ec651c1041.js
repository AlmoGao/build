import{dV as e,dT as t,dX as o,ex as i,dU as n}from"./00ec651c.js";import{n as r,r as s}from"./00ec651c1007.js";import{a as c}from"./00ec651c1008.js";import{T as h}from"./00ec651c1042.js";const d={interpolate(e,t,o){if(2!==e.length||2!==t.length)throw new Error("inputRange and outputRange must be an array of length 2");const i=e[0]||0,n=e[1]||0,r=t[0]||0,s=t[1]||0;return o<i?r:o>n?s:(s-r)/(n-i)*(o-i)+r}},a=e`
  :host {
    width: 100%;
    display: block;
  }
