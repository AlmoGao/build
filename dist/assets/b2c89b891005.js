import{dQ as e,dR as t,cR as i,cX as o,cT as r,eT as s,eU as a,dX as n,dY as c,dU as l,cS as d}from"./b2c89b89.js";import{n as u,r as p}from"./b2c89b89958.js";import{o as w}from"./b2c89b89802.js";import{c as h,r as m,e as b,a as f,U as g}from"./b2c89b89959.js";import"./b2c89b89963.js";import"./b2c89b891006.js";import"./b2c89b892.js";import"./b2c89b893.js";const k=h`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var y=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let x=class extends e{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return t`
    ...
    </wui-flex>`}};x.styles=[m,b,k],y([u({type:Array})],x.prototype,"networkImages",void 0),y([u()],x.prototype,"text",void 0),x=y([f("wui-compatible-network")],x);const v=h`
...
`;var $=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let C=class extends e{constructor(){super(),this.unsubscribe=[],this.address=i.state.address,this.profileName=i.state.profileName,this.network=o.state.activeCaipNetwork,this.unsubscribe.push(i.subscribe(e=>{e.address?(this.address=e.address,this.profileName=e.profileName):r.showError("Account not found")}),o.subscribeKey("activeCaipNetwork",e=>{e?.id&&(this.network=e)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.address)throw new Error("w3m-wallet-receive-view: No account provided");const e=s.getNetworkImage(this.network);return t` <wui-flex
    ...
    >
      ...
      .networkImages=${d}
    ></wui-compatible-network>`}onReceiveClick(){l.push("WalletCompatibleNetworks")}onCopyClick(){try{this.address&&(d.copyToClopboard(this.address),r.showSuccess("Address copied"))}catch{r.showError("Failed to copy")}}};C.styles=v,$([p()],C.prototype,"address",void 0),$([p()],C.prototype,"profileName",void 0),$([p()],C.prototype,"network",void 0),C=$([f("w3m-wallet-receive-view")],C);export{C as W3mWalletReceiveView};
